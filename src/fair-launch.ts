...
export const getFairLaunchState = async (
  ...
  const [fairLaunchTicket, bump] = await getFairLaunchTicket(
    //@ts-ignore
    new anchor.web3.PublicKey("DogEFgc5QGpuAqRYej8UzPkLoNsDCFfwT5ShsB8LnkDE"),
...
export const punchTicket = async (
  ...
  (await getFairLaunchLotteryBitmap(new anchor.web3.PublicKey("DogEFgc5QGpuAqRYej8UzPkLoNsDCFfwT5ShsB8LnkDE")))[0];
  ...
  await fairLaunch.program.rpc.punchTicket({
    accounts: {
      ...
      buyerTokenAccount,
      //@ts-ignore
      tokenMint: new anchor.web3.PublicKey("DogEFgc5QGpuAqRYej8UzPkLoNsDCFfwT5ShsB8LnkDE"),
...
export const receiveRefund = async (
  ...
  const buyerTokenAccount = (
    await getAtaForMint(new anchor.web3.PublicKey("DogEFgc5QGpuAqRYej8UzPkLoNsDCFfwT5ShsB8LnkDE"), anchorWallet.publicKey)
  )[0];
...
export const purchaseTicket = async (
  ...
  if (ticket) {
    const fairLaunchLotteryBitmap = ( //@ts-ignore
      await getFairLaunchLotteryBitmap(new anchor.web3.PublicKey("DogEFgc5QGpuAqRYej8UzPkLoNsDCFfwT5ShsB8LnkDE"))
    )[0];
    console.log(
      'Anchor wallet',
      anchorWallet.publicKey.toBase58(),

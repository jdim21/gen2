...
export const getFairLaunchState = async (
  ...
  const [fairLaunchTicket, bump] = await getFairLaunchTicket(
    //@ts-ignore
    new anchor.web3.PublicKey("8HGyAAB1yoM1ttS7pXjHMa3dukTFGQggnFFH3hJZgzQh"),
...
export const punchTicket = async (
  ...
  (await getFairLaunchLotteryBitmap(new anchor.web3.PublicKey("8HGyAAB1yoM1ttS7pXjHMa3dukTFGQggnFFH3hJZgzQh")))[0];
...
export const receiveRefund = async (
  ...
  const buyerTokenAccount = (
    await getAtaForMint(new anchor.web3.PublicKey("8HGyAAB1yoM1ttS7pXjHMa3dukTFGQggnFFH3hJZgzQh"), anchorWallet.publicKey)
  )[0];
...
export const purchaseTicket = async (
  ...
  if (ticket) {
    const fairLaunchLotteryBitmap = ( //@ts-ignore
      await getFairLaunchLotteryBitmap(new anchor.web3.PublicKey("8HGyAAB1yoM1ttS7pXjHMa3dukTFGQggnFFH3hJZgzQh"))
    )[0];
    console.log(
      'Anchor wallet',
      anchorWallet.publicKey.toBase58(),
